...
public final class ActivityCache 
{
	...
	/**
	 * Maximum number of ActivityBean objects that may be in the cache.
	 */
	private int maxCacheSize = 80;

	/**
	 * The number of ActivityBean objects currently in the cache.
	 */
	 ...
	 * objects that refer to the actual ActivityBean.
	 */
	...
	*/
	...
	/**
	 * A ActivityBean object is passed to this method for addition to the cache.
	 */
	public void addActivity(ActivityBean bean) 
	{
		synchronized(updateLock)
		{ 
			Integer id = bean.getActivityId();
			if (null == cache.get(id)) 
			{
				...
				else 
				{
					...
					if (maxCacheSize < currentCacheSize) 
					{
						...
						cache.remove(newLink.bean.getActivityId());
						lru.next = null;
					} 
					else 
					{
	...
	/**
	 * Return the ActivityBean associated with the given key.
	 */
	public ActivityBean fetchActivity(Integer id) 
	{
		...
		if (null == foundLink) 
		{
			...
			try 
			{
				bean = ActivityManagerImpl.getInstance().loadByPrimaryKey(id);
			} 
	...
	/**
	 * Updates ActivityBean object in the cache.
	 */
	...
	/**
	 * Returns true if ActivityBean object is in the cache. FALSE otherwise
	 */
	public boolean isActivityInCache(ActivityBean bean) 
	{
		Integer id = bean.getActivityId();
